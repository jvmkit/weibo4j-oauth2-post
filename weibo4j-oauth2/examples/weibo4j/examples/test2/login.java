...
//    private static JSONObject cookie = new JSONObject(WeiboConfig.getValue("cookie"));
    ...
    private static String name = WeiboConfig.getValue("name");
    private static String pwd = WeiboConfig.getValue("pwd");
...
//        form.put("s","148cf864");
     ...
     */
    public static void  Login() throws ClientProtocolException, IOException, WeiboException {
        
    	
    	
    	login weibo = new login(name,pwd);
